...
| CC1101 | `E:\Work\Competition\电赛\E06-STM8资料 - 141016\3  相关范例程序\CC1101\BSP` | CC1101 寄存器、FIFO、GDO0 收发 | `Cc1101.c/.h`, `Cc1101Regs.h` | 重映射 SPI1（PB3/PB4/PB5），GDO0=PA5，Key CSN=PB11 |
...
| DipSwitch | 本工程 | 读取 PB12~PB15 四位拨码并显示逻辑 ID | `DipSwitch.c/.h` | ON=1、OFF=0，PB12 为显示第1位 |
